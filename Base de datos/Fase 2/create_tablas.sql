...
DROP TABLE XML_CLASIFICACION CASCADE CONSTRAINTS;
DROP TABLE XML_JORNADAS CASCADE CONSTRAINTS;
DROP TABLE XML_ULTIMA_JORNADA CASCADE CONSTRAINTS;
...
CREATE TABLE XML_CLASIFICACION (
    ID_XML_C NUMBER(2),
    RESULT CLOB,
    CONSTRAINT XML_C_ID_PK PRIMARY KEY (ID_XML_C)
);
CREATE TABLE XML_JORNADAS (
    ID_XML_J NUMBER(2),
    RESULT CLOB,
    CONSTRAINT XML_J_ID_PK PRIMARY KEY (ID_XML_J)
);
CREATE TABLE XML_ULTIMA_JORNADA (
    ID_XML_UJ NUMBER(2),
    RESULT CLOB,
    CONSTRAINT XML_UJ_ID_PK PRIMARY KEY (ID_XML_UJ)
);