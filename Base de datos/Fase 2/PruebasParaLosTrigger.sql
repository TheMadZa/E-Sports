...
INSERT INTO EQUIPOS VALUES(DEFAULT,'PruebaTrigger',
    TO_DATE('01/01/85','DD/MM/YY'),'A','Rojo');

COMMIT;

SELECT ID_EQUIPO FROM EQUIPOS WHERE NOM_EQUIPO = 'PruebaTrigger';
...
INSERT INTO JUGADORES VALUES(DEFAULT,'Juan','JuanGOD','Colombia','Jugador',
...
INSERT INTO JUGADORES VALUES(DEFAULT,'Luis','LuisGOD','Colombia','Jugador',
    TO_DATE('02/03/98','DD/MM/YY'),3500,1);
INSERT INTO JUGADORES VALUES(DEFAULT,'David','DavidGOD','Colombia','Jugador',
    TO_DATE('02/03/98','DD/MM/YY'),3500,1);
INSERT INTO JUGADORES VALUES(DEFAULT,'Zahir','ZaGOD','Colombia','Jugador',
    TO_DATE('02/03/98','DD/MM/YY'),3500,1);
INSERT INTO JUGADORES VALUES(DEFAULT,'Ibai','YaleroGOD','Colombia','Jugador',
    TO_DATE('02/03/98','DD/MM/YY'),3500,1);
INSERT INTO JUGADORES VALUES(DEFAULT,'Lorena','LorenaGOD','Colombia','Jugador',
    TO_DATE('02/03/98','DD/MM/YY'),3500,1);
...
INSERT INTO JUGADORES VALUES(DEFAULT,'DIOS','DIOSGOD','Colombia','Jugador',
    TO_DATE('02/03/98','DD/MM/YY'),3500,1);
...
DELETE FROM
JUGADORES WHERE ID_JUGADOR = 1;
DELETE FROM
JUGADORES WHERE ID_JUGADOR = 2;
DELETE FROM
JUGADORES WHERE ID_JUGADOR = 3;
DELETE FROM
JUGADORES WHERE ID_JUGADOR = 4;
...
INSERT INTO EQUIPOS VALUES(DEFAULT,'PruebaTrigger2',
    TO_DATE('01/01/85','DD/MM/YY'),'A','Rojo');
...
SELECT ID_JUGADOR FROM JUGADORES WHERE ID_EQUIPO = 2;
...
INSERT INTO JORNADAS VALUES(DEFAULT,'17',TO_DATE('30/08/24','DD/MM/YY'),2);

COMMIT;

SELECT * FROM JORNADAS WHERE ID_JORNADA = 34;
/*Resultado:
...
INSERT INTO EQUIPOS VALUES(DEFAULT,'PruebaTrigger3',
    TO_DATE('01/01/85','DD/MM/YY'),'A','Rojo');
    COMMIT;
*/
INSERT INTO JORNADAS VALUES(DEFAULT,'18',TO_DATE('07/09/24','DD/MM/YY'),2);
...
/*
SELECT * FROM COMPETICIONES WHERE ETAPA = 'A';
SELECT * FROM EQUIPOS_COMPETICIONES;

Creamos un equipo con 6 jugadores
INSERT INTO EQUIPOS VALUES(DEFAULT,'PruebaTrigger4',
    TO_DATE('01/01/85','DD/MM/YY'),'A','Rojo');
COMMIT;

SELECT ID_EQUIPO FROM EQUIPOS WHERE NOM_EQUIPO = 'PruebaTrigger4';
...
INSERT INTO JUGADORES VALUES(DEFAULT,'Lorena','LorenaGOD','Colombia','Jugador',
    TO_DATE('02/03/98','DD/MM/YY'),3500,38);
INSERT INTO JUGADORES VALUES(DEFAULT,'Mati','ELMati','Colombia','Jugador',
...
INSERT INTO EQUIPOS_COMPETICIONES VALUES(38,1,0,0);

COMMIT;

SELECT * FROM EQUIPOS_COMPETICIONES WHERE ID_EQUIPO = 38;
...
/*
SELECT * FROM COMPETICIONES WHERE ETAPA = 'C';
SELECT * FROM EQUIPOS_COMPETICIONES;

Creamos un equipo con 6 jugadores
INSERT INTO EQUIPOS VALUES(DEFAULT,'PruebaTrigger5',
    TO_DATE('01/01/85','DD/MM/YY'),'A','Rojo');
COMMIT;

SELECT ID_EQUIPO FROM EQUIPOS WHERE NOM_EQUIPO = 'PruebaTrigger5';
...
ORDER BY ID_EQUIPO;
*/
INSERT INTO EQUIPOS_COMPETICIONES VALUES(39,2,0,0);

COMMIT;

SELECT * FROM EQUIPOS_COMPETICIONES WHERE ID_EQUIPO = 39;
/*Resultado:
...
SELECT * FROM EQUIPOS_COMPETICIONES WHERE ID_COMPETICION = 2;
...
INSERT INTO EQUIPOS VALUES(DEFAULT,'PruebaTrigger6',
    TO_DATE('01/01/85','DD/MM/YY'),'A','Rojo');
...
INSERT INTO JUGADORES VALUES(DEFAULT,'Ibai','Yalero','Colombia','Jugador',
